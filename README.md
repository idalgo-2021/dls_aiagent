...
python3 main.py
```
* В режиме Telegram-бота *(в этом варианте консольный клиент также будет запущен, но в Telegram не будут выводиться промежуточные шаги "размышления" и действия агента)*
```
